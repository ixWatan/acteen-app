...
public class SlideShowActivityAct3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_slide_show_act3);
    ...
    private void NextFunction() {
        Intent intent = new Intent(this, SlideShowActivityAct4.class);
        startActivity(intent);
        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
