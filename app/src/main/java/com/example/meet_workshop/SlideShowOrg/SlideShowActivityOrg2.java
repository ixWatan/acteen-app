...
public class SlideShowActivityOrg2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_slide_show_org2);
    ...
    private void NextFunction() {
        Intent intent = new Intent(this, SlideShowActivityOrg3.class);
        startActivity(intent);
        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
