...
public class SlideShowActivityOrg1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_slide_show_org1);
    ...
    private void NextFunction() {
        Intent intent = new Intent(this, SlideShowActivityOrg2.class);
        startActivity(intent);
        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
